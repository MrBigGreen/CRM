using Offertech.CodeGenerator.Comm;
using Offertech.CodeGenerator.Model;
...
namespace Offertech.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 6.1
    /// 苏州欧孚科技
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("using Offertech.Application.Code;\r\n\r\n");

            sb.Append("namespace Offertech.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string IsCreateUserId(DataTable dt)
        {
            ...
            if (newdt.Rows.Count > 0)
            {
                return "this.CreateUserId = OperatorProvider.Provider.Current().LoginInfo.UserId;\r\n";
            }
            return "";
        }
        public string IsCreateUserName(DataTable dt)
        {
            ...
            if (newdt.Rows.Count > 0)
            {
                return "this.CreateUserName = OperatorProvider.Provider.Current().LoginInfo.UserName;\r\n";
            }
            return "";
        }
        ...
        public string IsModifyUserId(DataTable dt)
        {
            ...
            if (newdt.Rows.Count > 0)
            {
                return "this.ModifyUserId = OperatorProvider.Provider.Current().LoginInfo.UserId;\r\n";
            }
            return "";
        }
        public string IsModifyUserName(DataTable dt)
        {
            ...
            if (newdt.Rows.Count > 0)
            {
                return "this.ModifyUserName = OperatorProvider.Provider.Current().LoginInfo.UserName;\r\n";
            }
            return "";
        }
        #endregion
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Offertech.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace Offertech.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Offertech.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Data.Repository;\r\n");
            sb.Append("using Offertech.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.Append("namespace Offertech.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace Offertech.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using Offertech.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Offertech.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Offertech.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Offertech.Util;\r\n");
            sb.Append("using Offertech.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Offertech.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string IndexBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("            dialogOpen({\r\n");
            sb.Append("                id: 'Form',\r\n");
            sb.Append("                title: '查看" + baseConfigModel.Description + "',\r\n");
            sb.Append("                url: '/" + areasUrl + "/Detail?keyValue=' + keyValue,\r\n");
            sb.Append("                width: '" + baseConfigModel.formModel.width + "px',\r\n");
            sb.Append("                height: '" + baseConfigModel.formModel.height + "px',\r\n");
            sb.Append("                callBack: function (iframeId) {\r\n");
            sb.Append("                    top.frames[iframeId].AcceptClick();\r\n");
            ...
            sb.Append("            <a id=\"lr-detail\" class=\"btn btn-default\" onclick=\"btn_detail()\"><i class=\"fa fa-list-alt\"></i>★详细</a>\r\n");
            sb.Append("        </div>\r\n");
            sb.Append("    </div>\r\n");
            sb.Append("</div>\r\n");
