    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("using PayMS.Application.Code;\r\n\r\n");


                sb.Append("namespace PayMS.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// 苏州欧孚科技\r\n");
                ...
                foreach (var item in gridColumnModel)
                {
                    ...
                    {
                        strCreateUserId = "this.CreateUserId = OperatorProvider.Provider.Current().LoginInfo.UserId;\r\n";
                    }
                    if (column == "CreateUserName")
                    {
                        strCreateUserName = "this.CreateUserName = OperatorProvider.Provider.Current().LoginInfo.UserName;\r\n";
                    }
                    ...
                    {
                        strModifyUserId = "this.ModifyUserId = OperatorProvider.Provider.Current().LoginInfo.UserId;\r\n";
                    }
                    if (column == "ModifyUserName")
                    {
                        strModifyUserName = "this.ModifyUserName = OperatorProvider.Provider.Current().LoginInfo.UserName;\r\n";
                    }
                    #endregion
                }
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using PayMS.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace PayMS.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using PayMS.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Data.Repository;\r\n");
            sb.Append("using PayMS.Util.WebControl;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.Append("namespace PayMS.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
            ...
            sb.Append("                    item." + multiTableConfigModel.DataBaseTablePK + " = entity." + multiTableConfigModel.DataBaseTablePK + ";\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace PayMS.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using PayMS.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace PayMS.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using PayMS.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using PayMS.Util;\r\n");
            sb.Append("using PayMS.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace PayMS.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// 苏州欧孚科技\r\n");
