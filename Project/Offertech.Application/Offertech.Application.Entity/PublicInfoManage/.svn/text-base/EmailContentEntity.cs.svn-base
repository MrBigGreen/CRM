...
namespace Offertech.Application.Entity.PublicInfoManage
{
    ...
    public class EmailContentEntity : BaseEntity
    {
        ...
        public override void Create()
        {
            ...
            this.SenderId = OperatorProvider.Provider.Current().LoginInfo.UserId;
            this.SenderName = OperatorProvider.Provider.Current().LoginInfo.UserName + "（" + OperatorProvider.Provider.Current().LoginInfo.Account + "）";
            this.DeleteMark = 0;
            this.EnabledMark = 1;
        }
        /// <summary>
