...
namespace Offertech.Application.Service.SystemManage
{
    /// <summary>
    /// 版 本 6.1
    /// 苏州欧孚科技
    ...
    public class CodeRuleService : RepositoryFactory<CodeRuleEntity>, ICodeRuleService
    {
        ...
        #region 单据编码处理
        /// <summary>
        /// 获得指定模块或者编号的单据号（未登录用户使用）
        /// </summary>
        /// <param name="userId">用户ID</param>
        /// <param name="moduleId">模块ID</param>
        /// <param name="enCode">模板编码</param>
        /// <returns>单据号</returns>
        public string GetBillCodeNologin(string userId, string moduleId, string enCode)
        {
            ...
            {
                //取得最大种子
                maxSeed = codeRuleSeedlist.Find(t => t.UserId == null && t.RuleId == coderuleentity.RuleId);
            }
            ...
            if (maxSeed == null)
            {
                ...
                maxSeed.Create();
                maxSeed.SeedValue = 1;
                maxSeed.RuleId = coderuleentity.RuleId;
        ...
        public string GetBillCode(string userId, string moduleId, string enCode)
        {
            ...
            //取得最大种子
            CodeRuleSeedEntity maxSeed = null;
            if (codeRuleSeedlist != null && codeRuleSeedlist.Count > 0)
            {
                //取得最大种子
                maxSeed = codeRuleSeedlist.Find(t => t.UserId == null && t.RuleId == coderuleentity.RuleId);
            }
        ...
        /// <param name="enCode">模板编码</param>
        /// <returns>单据号</returns>
        public string SetBillCodeNologin(string userId, string moduleId, string enCode)
        {
            IRepository db = new RepositoryFactory().BaseRepository();
