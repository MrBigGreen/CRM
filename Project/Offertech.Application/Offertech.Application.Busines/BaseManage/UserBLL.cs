...
namespace Offertech.Application.Busines.BaseManage
{
    ...
    public class UserBLL
    {
        ...
        /// <param name="password">密码</param>
        /// <returns></returns>
        public UserEntity CheckLogin(string openId, string username, string password)
        {
            UserEntity userEntity = service.CheckLogin(username);
            if (userEntity != null)
            {
        ...
        /// <param name="password">密码</param>
        /// <returns></returns>
        public UserEntity WechatLogin(string openId)
        {
            UserEntity userEntity = service.WechatLogin(openId);
            if (userEntity != null)
            {
                if (userEntity.EnabledMark == 1)
                {
        ...
        private void UpdateIMUserList(string keyValue, bool isAdd, UserEntity userEntity)
        {
            try
            {
                ...
                if (userEntity != null)
                {
                    ...
                    entity.Gender = userEntity.Gender.ToInt();
        ...
        public void SaveWechatId(string keyValue, string WeChatId)
        {
            try
            {
                service.SaveWechatId(keyValue, WeChatId);
            }
            catch (Exception)
            {
                throw;
        ...
        public void GetExportList()
        {
            ...
            excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "telephone", ExcelColumn = "电话" });
