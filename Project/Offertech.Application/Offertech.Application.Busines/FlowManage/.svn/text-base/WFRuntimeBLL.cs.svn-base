...
namespace Offertech.Application.Busines.FlowManage
{
    ...
    public class WFRuntimeBLL
    {
        ...
        {
            return wfProcessInstanceService.GetToMeBeforeCount();
        }
        /// <summary>
        /// 获取登录者已经处理的流程
        /// </summary>
        ...
        public WFProcessSchemeEntity GetProcessSchemeEntityByUserId(string keyValue)
        {
            try
            {
                ...
                entity.SchemeContent = wfRuntimeService.GetProcessSchemeContentByUserId(entity.SchemeContent, OperatorProvider.Provider.Current().LoginInfo.UserId);
                return entity;
            }
            catch
            {
