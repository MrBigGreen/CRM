...
namespace Offertech.Application.Busines.CustomerManage
{
    ...
    {
        private ISubscribeService service = new SubscribeService();
        ...
        {
            return service.GetPageList(customerId, pagination, queryJson);
        }
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        {
            return service.GetAuthorizePageList(customerId, pagination, queryJson);
        }
        /// <summary>
        /// 获取列表
        /// </summary>
