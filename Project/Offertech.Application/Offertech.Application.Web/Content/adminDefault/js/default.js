...
loadnav = function () {
    ...
    tablist = $("#tab_list_add").Tab({
        items: [
            { id: '23713d3a-810f-422d-acd5-39bec28ce47e', title: '日程管理', closed: false, icon: 'fa fa fa-desktop', url: contentPath + '/PublicInfoManage/Schedule/Index' },
        ],
        tabScroll: false,
