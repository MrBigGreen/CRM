...
namespace Offertech.Application.Web.Controllers
{
    ...
    public class PersonCenterController : MvcControllerBase
    {
        ...
        public ActionResult UploadFile()
        {
            ...
            userBLL.UpdateEntity(userEntity);
            return Success("上传成功。");
        }
        /// <summary>
        /// 验证旧密码
        ...
        /// <param name="OICQ"></param>
        /// <param name="MSN"></param>
        /// <returns></returns>
        [HttpPost]
        [AjaxOnly]
        public ActionResult SaveContactInfo(string Mobile, string Telephone, string Email, string WeChat, string OICQ, string MSN)
        {
            UserEntity entity = new UserEntity();
            entity.Mobile = Mobile;
            entity.Telephone = Telephone;
            entity.Email = Email;
            entity.WeChat = WeChat;
            entity.OICQ = OICQ;
            entity.MSN = MSN;
            entity.Modify(OperatorProvider.Provider.Current().LoginInfo.UserId);
            userBLL.UpdateEntity(entity);
            return Success("操作成功。");
        }
        #endregion
    }
