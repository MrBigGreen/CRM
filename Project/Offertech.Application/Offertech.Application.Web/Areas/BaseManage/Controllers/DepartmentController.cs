            ...
            if (!string.IsNullOrEmpty(condition) && !string.IsNullOrEmpty(keyword))
            {
                ...
                switch (condition)
                {
                    case "FullName":    //部门名称
                        ...
                        break;
                    case "EnCode":      //部门编号
                        departmentdata = departmentdata.TreeWhere(t => !string.IsNullOrEmpty(t.EnCode) && t.EnCode.Contains(keyword), "DepartmentId");
                        break;
                    case "ShortName":   //部门简称
                        departmentdata = departmentdata.TreeWhere(t => !string.IsNullOrEmpty(t.ShortName) && t.ShortName.Contains(keyword), "DepartmentId");
                        break;
                    case "Manager":     //负责人
                        departmentdata = departmentdata.TreeWhere(t => !string.IsNullOrEmpty(t.Manager) && t.Manager.Contains(keyword), "DepartmentId");
                        break;
                    case "OuterPhone":  //电话号
                        departmentdata = departmentdata.TreeWhere(t => !string.IsNullOrEmpty(t.OuterPhone) && t.OuterPhone.Contains(keyword), "DepartmentId");
                        break;
                    case "InnerPhone":  //分机号
                        departmentdata = departmentdata.TreeWhere(t => !string.IsNullOrEmpty(t.InnerPhone) && t.InnerPhone.Contains(keyword), "DepartmentId");
                        break;
                    default:
                        break;
                }
