            ...
            if (!string.IsNullOrEmpty(condition) && !string.IsNullOrEmpty(keyword))
            {
                ...
                switch (condition)
                {
                    case "FullName":    //公司名称
                        ...
                        break;
                    case "EnCode":      //外文名称
                        data = data.TreeWhere(t => !string.IsNullOrEmpty(t.EnCode) && t.EnCode.Contains(keyword), "OrganizeId");
                        break;
                    case "ShortName":   //中文名称
                        data = data.TreeWhere(t => !string.IsNullOrEmpty(t.ShortName) && t.ShortName.Contains(keyword), "OrganizeId");
                        break;
                    case "Manager":     //负责人
                        data = data.TreeWhere(t => !string.IsNullOrEmpty(t.Manager) && t.Manager.Contains(keyword), "OrganizeId");
                        break;
                    default:
                        break;
                }
