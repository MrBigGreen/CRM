using Offertech.Data.EF.Extension;
...
namespace Offertech.Data.EF
{
    ...
    public class Database : IDatabase
    {
        ...
        public int ExecuteBySql(string strSql)
        {
            ...
            {
                var count = dbcontext.Database.ExecuteSqlCommand(strSql);
                if (dbTransaction == null)
                {
                    return this.Commit();
                }
        ...
        public int ExecuteBySql(string strSql, params DbParameter[] dbParameter)
        {
            ...
            {
                var count = dbcontext.Database.ExecuteSqlCommand(strSql, dbParameter);
                if (dbTransaction == null)
                {
                    return this.Commit();
                }
        ...
        #region 对象实体 查询
        public IEnumerable<T> SqlQuery<T>(string strSql, DbParameter[] dbParameter) where T : class,new()
        {
            return dbcontext.Database.SqlQuery<T>(strSql, dbParameter);
        }
