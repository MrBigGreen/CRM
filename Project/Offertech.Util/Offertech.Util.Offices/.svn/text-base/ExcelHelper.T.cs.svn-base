...
namespace Offertech.Util.Offices
{
    /// <summary>
    ///版 本 V1.0
    ...
    public class ExcelHelper<T>
    {
        ...
        public static MemoryStream ExportMemoryStream(List<T> lists, ExcelConfig excelConfig)
        {
            ...
            #region 右击文件 属性信息
            {
                ...
                si.Author = "chand"; //填加xls文件作者信息
                si.ApplicationName = "力软信息"; //填加xls文件创建程序信息
                si.LastAuthor = "chand"; //填加xls文件最后保存者信息
                si.Comments = "chand"; //填加xls文件作者信息
        ...
        /// <returns></returns>
        public static List<T> ExcelImport(Hashtable head, string workbookFile)
        {
            try
            {
