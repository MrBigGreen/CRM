...
using Offertech.Util.WeChat.Model;
using Offertech.Util.WeChat.Model.Request;
using Offertech.Util.WeChat.Model.Request.SendMessage;
using Offertech.Util;
using Offertech.Util.WeChat.Helper;

namespace Offertech.Util.WeChat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        {
            //        description="测试新闻",
            //        picurl="http://www.Offertech.cn/images/banner3.jpg",
            //        url="http://www.Offertech.cn/fdms/index.html",
            //        title="力软在线"
            //        },
            //                            new SendNews.SendItem
            //        {
