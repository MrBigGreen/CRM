...
namespace CRM.IBLL
{
    ...
    public partial interface ISysFieldBLL
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<SysField> GetByParam(string id, int page, int rows, string order, string sort, string search, ref int total);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<SysField> GetByParam(string id, string order, string sort, string search); /*在6.0版本中 新增*/
        /// <summary>
        /// 获取所有
        /// </summary>
        /// <returns></returns>
