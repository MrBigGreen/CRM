...
namespace CRM.IBLL
{
    ...
    public partial interface ISysMenuSysRoleSysOperationBLL
    {
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<SysMenuSysRoleSysOperation> GetByParam(string id, string order, string sort, string search); /*在6.0版本中 新增*/
        /// <summary>
        /// 获取所有
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        List<SysMenuSysRoleSysOperation> GetByRefSysRoleId(string id);
        ...
        /// <returns></returns>
        [OperationContract]
         bool Create(ref Common.ValidationErrors validationErrors, SysMenuSysRoleSysOperation entity); 
        /// <summary>
        /// 删除一个对象
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        ...
        /// <returns></returns>
        [OperationContract]
        bool Edit(ref Common.ValidationErrors validationErrors, SysMenuSysRoleSysOperation entity); 
