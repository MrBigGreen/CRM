...
namespace CRM.IBLL
{
    ...
    public partial interface ISysDepartmentBLL
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<SysDepartment> GetByParam(string id, string order, string sort, string search); /*在6.0版本中 新增*/
        /// <summary>
        /// 获取所有
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [OperationContract]
         bool Create(ref Common.ValidationErrors validationErrors, SysDepartment entity); 
        /// <summary>
        /// 删除一个对象
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
