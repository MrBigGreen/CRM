...
namespace CRM.DAL
{
    ...
    /// 数据字典
    /// </summary>
    public partial class SysFieldRepository : BaseRepository<SysField>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<SysField> DaoChuData(DB_CRMEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<SysField>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">主键</param>
        /// <returns>数据字典</returns>
        public SysField GetById(DB_CRMEntities db, string id)
        { 
