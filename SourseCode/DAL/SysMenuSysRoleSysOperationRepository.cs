...
namespace CRM.DAL
{
    ...
    public partial class SysMenuSysRoleSysOperationRepository : BaseRepository<SysMenuSysRoleSysOperation>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysMenuSysRoleSysOperation> DaoChuData(DB_CRMEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>菜单角色操作</returns>
        public SysMenuSysRoleSysOperation GetById(DB_CRMEntities db, string id)
        { 
        ...
        /// <returns></returns>
        public IQueryable<SysMenuSysRoleSysOperation> GetByRefSysMenuId(DB_CRMEntities db, string id)
        {
        ...
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<SysMenuSysRoleSysOperation> GetByRefSysOperationId(DB_CRMEntities db, string id)
        {
            return from c in db.SysMenuSysRoleSysOperation
        ...
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<SysMenuSysRoleSysOperation> GetByRefSysRoleId(DB_CRMEntities db, string id)
        {
            return from c in db.SysMenuSysRoleSysOperation
