...
namespace CRM.DAL
{
    ...
    public partial class TB_CustomerVerification
    {
    	
    	  public TB_CustomerVerification()
        {
                ...
                // </auto-generated>
                //------------------------------------------------------------------------------
    			this.CustomerVerificationID = String.Empty;
    				this.CustomerNewName = String.Empty;
    	    ...
    	    public string CustomerVerificationID { get; set; }
