...
namespace CRM.DAL
{
    ...
    /// 日志
    /// </summary>
    public partial class SysLogRepository : BaseRepository<SysLog>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<SysLog> DaoChuData(DB_CRMEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>日志</returns>
        public SysLog GetById(DB_CRMEntities db, string id)
        { 
