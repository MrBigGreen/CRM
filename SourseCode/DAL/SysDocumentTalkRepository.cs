...
namespace CRM.DAL
{
    ...
    public partial class SysDocumentTalkRepository : BaseRepository<SysDocumentTalk>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysDocumentTalk> DaoChuData(DB_CRMEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>文档评论</returns>
        public SysDocumentTalk GetById(DB_CRMEntities db, string id)
        { 
        ...
        /// <returns></returns>
        public IQueryable<SysDocumentTalk> GetByRefSysDocumentId(DB_CRMEntities db, string id)
        {
