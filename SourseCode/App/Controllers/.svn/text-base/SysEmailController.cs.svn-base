...
namespace CRM.App.Controllers
{
    ...
    /// 邮件发送记录
    /// </summary>
    public class SysEmailController : BaseController
    {
        ...
        public JsonResult GetData(string id, int page, int rows, string order, string sort, string search)
        {
            ...
            int total = 0;
            List<SysEmail> queryData = m_BLL.GetByParam(id, page, rows, order, sort, search, ref total);
        ...
        public ActionResult Export(string id, string title, string field, string sortName, string sortOrder, string search)
        {
            ...
            List<SysEmail> queryData = m_BLL.GetByParam(id, sortOrder, sortName, search);
        ...
        IBLL.ISysEmailBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public SysEmailController()
            : this(new SysEmailBLL()) { }

        public SysEmailController(SysEmailBLL bll)
        {
            m_BLL = bll;
        }
