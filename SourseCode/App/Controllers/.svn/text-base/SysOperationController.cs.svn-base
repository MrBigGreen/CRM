...
namespace CRM.App.Controllers
{
    ...
    public class SysOperationController : BaseController
    {
        ...
        public JsonResult GetAllData()
        {
            ...
            int total = 0;
            List<SysOperation> queryData = m_BLL.GetByParam(null, 1, 100, "asc", "Sort", null, ref total);
            return Json(
        ...
        public ActionResult Export(string id, string title, string field, string sortName, string sortOrder, string search)
        {
            ...
            List<SysOperation> queryData = m_BLL.GetByParam(id, sortOrder, sortName, search);
