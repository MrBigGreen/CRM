...
namespace CRM.App.Models
{
    ...
    public class SysFieldTreeNodeCollection
    {
        ...
        public bool Bind(IEnumerable<SysField> entitys, string myParentId, ref List<SystemTree> myChildren)
        {
            if (null != myParentId)
            ...
            {//填充数据
                ...
                {
                    SystemTree myTree = new SystemTree() { id = item.Id.GetString(), text = item.MyTexts.GetString() };
