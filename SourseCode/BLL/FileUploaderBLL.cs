...
namespace CRM.BLL
{
    ...
    /// 附件 
    /// </summary>
    public partial class FileUploaderBLL :  IBLL.IFileUploaderBLL, IDisposable
    {
        /// <summary>
        /// 私有的数据访问上下文
        /// </summary>
        ...
        public FileUploaderBLL(DB_CRMEntities entities)
        {
            db = entities;
        }
        /// <summary>
        ...
        /// <param name="total">结果集的总数</param>
        /// <returns>结果集</returns>
        public List<FileUploader> GetByParam(string id, string order, string sort, string search)
        {
            IQueryable<FileUploader> queryData = repository.DaoChuData(db, order, sort, search);
